                        ...
                        <div class="card">
                            <div class="filter">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <li><a class="dropdown-item" href="#" id="thisWeek">This Week</a></li>
                            ...
                            <div class="card-body">
                                ...
                                <script>
                                    ...
                                    document.addEventListener('DOMContentLoaded', () => {
                                        // Tampilkan chart untuk 'Today' secara default
                                        showChart('today');

                                        // Tambahkan event listener untuk dropdown
                                        document.getElementById('today').addEventListener('click', (e) => {
                                            e.preventDefault(); // Mencegah reload halaman
                                            document.getElementById('dateLabel').textContent = '/Today'; // Update label
                                            showChart('today'); // Perbarui chart
                                        });

                                        document.getElementById('thisWeek').addEventListener('click', (e) => {
                                            e.preventDefault();
                                            document.getElementById('dateLabel').textContent = '/This Week';
                                            showChart('week'); // Perbarui chart (sesuaikan dengan period data)
                                        });

                                        document.getElementById('thisMonth').addEventListener('click', (e) => {
                                            e.preventDefault();
                                            document.getElementById('dateLabel').textContent = '/This Month';
                                            showChart('month'); // Perbarui chart
                                        });
                                    });
                                </script>
                            </div>
